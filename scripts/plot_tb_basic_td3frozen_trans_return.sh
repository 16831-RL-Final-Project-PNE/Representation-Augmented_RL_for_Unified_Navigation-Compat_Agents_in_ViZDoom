...
python -m eval.plot_tb_avg_return \
  --logdirs \
    ...
    /data/patrick/16831RL/logs/tb_basic_ppo_jepa_td3_unfreeze1 \
    /data/patrick/16831RL/logs/tb_basic_ppo_jepa_td3_unfreeze2 \
    /data/patrick/16831RL/logs/tb_basic_ppo_jepa_td3_fullft \
